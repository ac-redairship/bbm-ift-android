...
class TransferToBottomSheet(private val type: TransferStatus,
                            private val bottomInterface: TransferToBottomInterface
):
    BBBottomSheet(), TransferToBottomInterface {
    ...
    var listAdapter : TransferToBottomSheetAdapter? = null
...
//                        showError(it)
    ...
    private fun populateAdapterWithInfo(list : List<TransferToTypeResponse>){
        listAdapter =
            activity?.let { TransferToBottomSheetAdapter(ArrayList(list), this@TransferToBottomSheet) }
        listAdapter?.let {
    ...
    companion object {
        ...
        = TransferToBottomSheet(type, bottomInterface)
    }
